...
def train(hyp, opt, device, tb_writer=None):
    ...
    init_seeds(2 + rank)
    with open(opt.data, encoding='gbk') as f:
        print(f)
    ...
    compute_loss = ComputeLoss(model, kpt_label=kpt_label, kpt_num=kpt_num , nc=model.nc)  # init loss class
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='shiliyu/Yolov5s6_pose_640.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default= 'shiliyu/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default= 'shiliyu/coco_kpts.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='shiliyu/hyp_scratch.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--kpt-label',default=True, action='store_true', help='use keypoint labels for training')


#----------- 自定义关键点个数----------------------------- 
#---------需要修改plot部分、修改loss部分
#---------修改non_max_suppression、non_max_suppression_export部分 关键点个数
#---------
    parser.add_argument('--my_kpt', type=int, default=4, help='关键点个数')
