...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'C:\Users\14685\Desktop\edgeai-yolov5-yolo-pose\runs\train\exp\weights\best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r'C:\Users\14685\Desktop\data\images', help='source')  # file/folder, 0 for webcam
